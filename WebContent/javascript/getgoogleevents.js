...
var clientId = '720360298637-ml6mupplmpds4f8h70ci4b9fid61pjhp.apps.googleusercontent.com'; //choose web app client Id, redirect URI and Javascript origin set to http://localhost
var apiKey = 'AIzaSyCcnwJdZr1_z0tYd2eJPrhktdBRxa-rC3U'; //choose public apiKey, any IP allowed (leave blank the allowed IP boxes in Google Dev Console)
var userEmail = "roxxi.popescu@gmail.com"; //your calendar Id
var userTimeZone = "Europe/Bucharest"; //example "Rome" "Los_Angeles" ecc...
var maxRows = 10; //events to shown
var calName = "Restaurant Events"; //name of calendar (write what you want, doesn't matter)
